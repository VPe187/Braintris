...
public class Layer {
    ...
    public LayerGradients backwardBatch(double[][] nextLayerDeltas, double[][] inputs) {
        ...
        // Batch averaging and clipping gradients
    ...
    // Calculate activation function derivates
    ...
    // Gradient normalizing and clipping
